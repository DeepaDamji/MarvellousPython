...
def main():
	...
	print("Description: Python Program to calulate execution time required to find & delete duplicate files in directory");
	...
	if sys.argv[1] == "-h" or sys.argv[1] == "-H":
		print("\nThis program is written to calulate execution time required to find & delete");
	...
	try:
		...
		deleteDuplicate(arr);
		endtime=time.time();
		print("Execution Time Required :",endtime-starttime);
